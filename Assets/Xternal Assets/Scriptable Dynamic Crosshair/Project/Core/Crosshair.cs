...
namespace Obscure.SDC {
    public class Crosshair : MonoBehaviour
    {
        ...
        [SerializeField] Vector2 minSize = new Vector2(40, 40);
        ...
        /// <param name="alpha">The transparency of the crosshair.</param>
        /// <param name="time">The time it takes for the color to change, in seconds. Default is 0.1 seconds.</param>
        public void SetColor(Color color, float _alpha, float time = 0.1f)
        {
